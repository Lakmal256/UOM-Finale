import "../ComponentStyles/profileTab.css";
...
const Profile = () => {
  ...
  return (
    <div>
      ...
      <div className="profile_form_main">
        {STUDENT.map((field) => {
          if (field.type === "select") {
            ...
            return (
              <div className="form_row_flex" key={field.left.id}>
                <div>
                  <div>{field.left.label}</div>
                  <input
      ...
      <div className="save_button_main">
